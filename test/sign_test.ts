...
Deno.test("shake-256 no header valid signature", () => {
  ...
  assertEquals(domainHex, "333d8686761cff65a3a2ef20bfa217d37bdf19105e87c210e9ce64ea1210a157")
...
Deno.test("shake-256 modified message signature", () => {
  ...
  const verification = verify(pkBytes, signatureBytes, generators, headerBytes, msgs, apiId, cipher)
...
Deno.test("shake-256 extra unsigned message signature", () => {
  ...
  const cipher = BLS12_381_SHAKE_256
  const apiId = concatenate(cipher.id, new TextEncoder().encode("H2G_HM2S_"))
  const generators = createGenerators(3, apiId, cipher)
  const msgs = messagesToScalars([msg_1, msg_2], apiId, cipher)
...
Deno.test("shake-256 reordered message signature", () => {
  const msg_10 = hexToBytes("9872ad089e452c7b6e283dfac2a80d58e8d0ff71cc4d5e310a1debdda4a45f02")
  const msg_9 = hexToBytes("c344136d9ab02da4dd5908bbba913ae6f58c2cc844b802a6f811f5fb075f9b80")
  const msg_8 = hexToBytes("7372e9daa5ed31e6cd5c825eac1b855e84476a1d94932aa348e07b73")
  const msg_7 = hexToBytes("77fe97eb97a1ebe2e81e4e3597a3ee740a66e9ef2412472c")
  const msg_6 = hexToBytes("496694774c5604ab1b2544eababcf0f53278ff50")
  const msg_5 = hexToBytes("515ae153e22aae04ad16f759e07237b4")
  const msg_4 = hexToBytes("d183ddc6e2665aa4e2f088af")
  const msg_3 = hexToBytes("ac55fb33a75909ed")
  const msg_2 = hexToBytes("96012096")
  const msg_1 = hexToBytes("")
...
Deno.test("shake-256 wrong header valid signature", () => {
  ...
  const headerBytes = hexToBytes("ffeeddccbbaa00998877665544332211")
  const pkBytes = hexToBytes(
    "92d37d1d6cd38fea3a873953333eab23a4c0377e3e049974eb62bd45949cdeb1" +
      "8fb0490edcd4429adff56e65cbce42cf188b31bddbd619e419b99c2c41b38179" +
      "eb001963bc3decaae0d9f702c7a8c004f207f46c734a5eae2e8e82833f3e7ea5",
