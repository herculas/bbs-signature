...
///
/// - `signer_nym_entropy`: a scalar value representing the signer's pseudonym entropy.
...
///
/// Return an element from the G1 subgroup representing the `B` value, or INVALID.
